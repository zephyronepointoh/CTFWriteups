...
For this challenge, we were given [code](Given%20Info/flag_art.py) that produced a file. The [file](/Given%20Info/output.txt) was made up of the characters .=w-o^* seemingly randomly assigned and arranged in the shape of the contest logo. 
